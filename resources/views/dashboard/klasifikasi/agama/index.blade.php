...
@section('title', 'Dashboard Page | Agama')
@section('content')
    ...
    <div class="row py-3 px-3">
        <div class="d-inline-flex p-2 justify-content-end gap-4">
            <a href="{{ route('dashboard-agama-create') }}" class="btn bg-primary border text-white shadow-lg">+ Tambah
                Agama</a>
        </div>
